...
# incomplete handling of method references: https://github.com/njit-jerse/specSlice/issues/291
# this test exists to check that no crash occurs, not that TypeSlice produces the correct output

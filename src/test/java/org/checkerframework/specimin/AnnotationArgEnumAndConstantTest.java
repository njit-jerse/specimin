 ...
 *
 * <p>{@link AnnotationArgConstantAndEnumTest} is the same input with the two arguments swapped;
 * Specimin reaches them in the opposite order, so the two tests exercise different paths.
 */
public class AnnotationArgEnumAndConstantTest {
  @Test
  public void runTest() throws IOException {
    SpeciminTestExecutor.runTestWithoutJarPaths(
        "annotationargenumandconstant",

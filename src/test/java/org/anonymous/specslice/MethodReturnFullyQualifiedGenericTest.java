 ...
 * synthetic return type should be com.qualified.Bar<com.foo.Foo>. This test encodes SpecSlice's
 * current behavior, which doesn't produce compilable output. If you break this test, it might not
 * be a bad thing.
 */

...
// for methods from List are in Baz. Then, TypeSlice removes List<E> from the class declaration,
// even though add() is called (and creates a synthetic add() method instead). This isn't the right
// behavior, but TypeSlice is currently limited without access to the full program.

...
/**
 * This visitor contains shared logic and state for the TypeSlice's various XVisitor classes. It
 ...
 */
public abstract class TypeSliceStateVisitor extends ModifierVisitor<Void> {
   ...
   * assignments to these fields will be preserved, so TypeSlice needs to avoid adding an
   ...
   */
  public TypeSliceStateVisitor(TypeSliceStateVisitor previous) {
